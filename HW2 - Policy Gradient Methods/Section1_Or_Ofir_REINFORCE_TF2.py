...
class REINFORCE:
    ...
    def update_policy(self, states, actions, targets):
        ...
        with tf.GradientTape() as tape:
            ...
            # policy_loss = -ln[Pr(A=a|S=states)] * Gt
            policy_loss = -tf.math.reduce_mean(log_prob * tf.cast(targets, tf.float32))
    ...
    def train(self):
        ...
        for episode in range(self.max_episodes):
            ...
            policy_loss = self.update_policy(states, actions, targets=returns)
...
if __name__ == '__main__':
    ...
    # This HP win after 1025 Episodes
    ...
    model = REINFORCE(env=env, hp=best_hyper_parameters, writer=writer)
    model.train()
