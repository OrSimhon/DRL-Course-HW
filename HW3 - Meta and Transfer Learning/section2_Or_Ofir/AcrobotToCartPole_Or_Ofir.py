...
# Actor Critic: Acrobot to Cart Pole
import numpy as np
import gym
...
class ActorNet:
    def __init__(self, state_size, action_size, Acrobot_model_W1, Acrobot_model_b1, name='ActorNetwork'):
        ...
        with tf.variable_scope(name):
            ...
            self.actions_distribution = tf.squeeze(self.output)
...
class ActorCritic_Agent:
    def __init__(self, env, sess, hp, writer, saved_model_path):
        ...
        self.sess = sess
        W1, b1 = self.load_acrobot_model(saved_model_path)
    ...
    def load_acrobot_model(self, saved_model_path):
        ...
        Acrobot_model_W1 = tf.constant(graph.get_tensor_by_name('ActorNetwork/W1:0').eval())
        Acrobot_model_b1 = tf.constant(graph.get_tensor_by_name('ActorNetwork/b1:0').eval())

        return Acrobot_model_W1, Acrobot_model_b1
